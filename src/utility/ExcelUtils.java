...
public static void setCellData2(String Result,  int RowNum, int ColNum) throws Exception    {
      ...
      // Constant variables Test Data path and Test Data file name
         FileOutputStream fileOut = new FileOutputStream(constant.Path_TestData2 + constant.File_TestData2);
